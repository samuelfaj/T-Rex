...
<div class="page">
    <div class="page-main">
        <div class="header py-4">
            <div class="container">
                <div class="d-flex">
                    <a class="header-brand" href="template/tabler/tabler/dist/index.html">
                        <img src="template/tabler/tabler/dist/demo/brand/tabler.svg" class="header-brand-img" alt="tabler logo">
                    </a>
                    <div class="d-flex order-lg-2 ml-auto">
                        ...
                        <div class="dropdown d-none d-md-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                <a href="#" class="dropdown-item d-flex">
                                    <span class="avatar mr-3 align-self-center" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/41.jpg)"></span>
                                    <div>
                                ...
                                <a href="#" class="dropdown-item d-flex">
                                    <span class="avatar mr-3 align-self-center" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/1.jpg)"></span>
                                    <div>
                                ...
                                <a href="#" class="dropdown-item d-flex">
                                    <span class="avatar mr-3 align-self-center" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/18.jpg)"></span>
                                    <div>
                        ...
                        <div class="dropdown">
                            <a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                                <span class="avatar" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/25.jpg)"></span>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row">
                            <li class="nav-item">
                                <a href="template/tabler/tabler/dist/index.html" class="nav-link active"><i class="fe fe-home"></i> Home</a>
                            </li>
                            <li class="nav-item">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-box"></i> Interface</a>
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    <a href="template/tabler/tabler/dist/cards.html" class="dropdown-item ">Cards design</a>
                                    <a href="template/tabler/tabler/dist/charts.html" class="dropdown-item ">Charts</a>
                                    <a href="template/tabler/tabler/dist/pricing-cards.html" class="dropdown-item ">Pricing cards</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-calendar"></i> Components</a>
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    <a href="template/tabler/tabler/dist/maps.html" class="dropdown-item ">Maps</a>
                                    <a href="template/tabler/tabler/dist/icons.html" class="dropdown-item ">Icons</a>
                                    <a href="template/tabler/tabler/dist/store.html" class="dropdown-item ">Store</a>
                                    <a href="template/tabler/tabler/dist/blog.html" class="dropdown-item ">Blog</a>
                                    <a href="template/tabler/tabler/dist/carousel.html" class="dropdown-item ">Carousel</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="javascript:void(0)" class="nav-link" data-toggle="dropdown"><i class="fe fe-file"></i> Pages</a>
                                <div class="dropdown-menu dropdown-menu-arrow">
                                    <a href="template/tabler/tabler/dist/profile.html" class="dropdown-item ">Profile</a>
                                    <a href="template/tabler/tabler/dist/login.html" class="dropdown-item ">Login</a>
                                    <a href="template/tabler/tabler/dist/register.html" class="dropdown-item ">Register</a>
                                    <a href="template/tabler/tabler/dist/forgot-password.html" class="dropdown-item ">Forgot password</a>
                                    <a href="template/tabler/tabler/dist/400.html" class="dropdown-item ">400 error</a>
                                    <a href="template/tabler/tabler/dist/401.html" class="dropdown-item ">401 error</a>
                                    <a href="template/tabler/tabler/dist/403.html" class="dropdown-item ">403 error</a>
                                    <a href="template/tabler/tabler/dist/404.html" class="dropdown-item ">404 error</a>
                                    <a href="template/tabler/tabler/dist/500.html" class="dropdown-item ">500 error</a>
                                    <a href="template/tabler/tabler/dist/503.html" class="dropdown-item ">503 error</a>
                                    <a href="template/tabler/tabler/dist/email.html" class="dropdown-item ">Email</a>
                                    <a href="template/tabler/tabler/dist/empty.html" class="dropdown-item ">Empty page</a>
                                    <a href="template/tabler/tabler/dist/rtl.html" class="dropdown-item ">RTL mode</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="template/tabler/tabler/dist/form-elements.html" class="nav-link"><i class="fe fe-check-square"></i> Forms</a>
                            </li>
                            <li class="nav-item">
                                <a href="template/tabler/tabler/dist/gallery.html" class="nav-link"><i class="fe fe-image"></i> Gallery</a>
                            </li>
                            <li class="nav-item">
                                <a href="template/tabler/tabler/dist/docs/index.html" class="nav-link"><i class="fe fe-file-text"></i> Documentation</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="my-3 my-md-5">
            <div class="container">
                ...
                <div class="row row-cards">
                        ...
                        <div class="card">
                            ...
                            <div class="table-responsive">
                                <table class="table card-table table-striped table-vcenter">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td class="w-1"><span class="avatar" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/9.jpg)"></span></td>
                                    ...
                                    <tr>
                                        <td><span class="avatar" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/1.jpg)"></span></td>
                                    ...
                                    <tr>
                                        <td><span class="avatar" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/4.jpg)"></span></td>
                                        <td>Bobby Knight</td>
                                    ...
                                    <tr>
                                        <td><span class="avatar" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/11.jpg)"></span></td>
                                        <td>Sharon Wells</td>
                                        <td>Fixes #625</td>
                    ...
                    <div class="col-md-6">
                        <div class="alert alert-primary">Are you in trouble? <a href="template/tabler/tabler/dist/docs/index.html" class="alert-link">Read our documentation</a> with code samples.</div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card">
                                    <div class="card-header">
                ...
                <div class="row row-cards row-deck">
                    <div class="col-lg-6">
                        <div class="card card-aside">
                            <a href="#" class="card-aside-column" style="background-image: url(template/tabler/tabler/dist/demo/photos/david-klaasen-54203-500.jpg)"></a>
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center pt-5 mt-auto">
                                    <div class="avatar avatar-md mr-3" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/18.jpg)"></div>
                                    <div>
                                        <a href="template/tabler/tabler/dist/profile.html" class="text-default">Rose Bradley</a>
                    ...
                    <div class="col-lg-6">
                        <div class="card card-aside">
                            <a href="#" class="card-aside-column" style="background-image: url(template/tabler/tabler/dist/demo/photos/david-marcu-114194-500.jpg)"></a>
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="d-flex align-items-center pt-5 mt-auto">
                                    <div class="avatar avatar-md mr-3" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/16.jpg)"></div>
                                    <div>
                                        <a href="template/tabler/tabler/dist/profile.html" class="text-default">Peter Richards</a>
                                        <small class="d-block text-muted">3 days ago</small>
                                    </div>
                                    <div class="ml-auto text-muted">
                                        <a href="javascript:void(0)" class="icon d-none d-md-inline-block ml-3"><i class="fe fe-heart mr-1"></i></a>
                                ...
                                <table class="table table-hover table-outline table-vcenter text-nowrap card-table">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/26.jpg)">
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/17.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/21.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/32.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/12.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/4.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/27.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <div class="avatar d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/20.jpg)">
                                                <span class="avatar-status bg-green"></span>
                                            </div>
                                        </td>
                                        <td>
                            ...
                            <div class="card-body o-auto" style="height: 15rem">
                                <ul class="list-unstyled list-separated">
                                    <li class="list-separated-item">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span class="avatar avatar-md d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/12.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div>
                                    ...
                                    <li class="list-separated-item">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span class="avatar avatar-md d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/21.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div>
                                    ...
                                    <li class="list-separated-item">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span class="avatar avatar-md d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/29.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div>
                                    ...
                                    <li class="list-separated-item">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span class="avatar avatar-md d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/2.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div>
                                    ...
                                    <li class="list-separated-item">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span class="avatar avatar-md d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/male/34.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div>
                                    ...
                                    <li class="list-separated-item">
                                        <div class="row align-items-center">
                                            <div class="col-auto">
                                                <span class="avatar avatar-md d-block" style="background-image: url(template/tabler/tabler/dist/demo/faces/female/11.jpg)"></span>
                                            </div>
                                            <div class="col">
                                                <div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item"><a href="template/tabler/tabler/dist/docs/index.html">Documentation</a></li>
                                <li class="list-inline-item"><a href="template/tabler/tabler/dist/faq.html">FAQ</a></li>
                            </ul>
                        </div>
                        <div class="col-auto">
